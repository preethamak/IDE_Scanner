...
from extension_scanner_cli.ui.renderers import render_scan_report
from extension_scanner_cli.ui.tables import ANSI_RE, table, visible_len
from extension_scanner_cli.ui.theme import color, severity_label
