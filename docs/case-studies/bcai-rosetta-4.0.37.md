...
The behavior-only replay recorded here is bound to the scanner build identity
captured in its machine-readable run report, with policy `3.1.0-calibration.7`,
